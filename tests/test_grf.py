...
class GrfGenerationTests(unittest.TestCase):
    def test_generation_is_deterministic_and_bounded(self):
        ...
        field_a = generate_grf_field(mesh, E_max=8.0, sigma_g=1.0, ell=1.0, seed=17)
        field_b = generate_grf_field(mesh, E_max=8.0, sigma_g=1.0, ell=1.0, seed=17)
    ...
    def test_material_generator_returns_one_field(self):
